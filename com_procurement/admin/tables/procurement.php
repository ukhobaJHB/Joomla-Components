 ...
 * @since  0.0.1
 */
class ProcurementTableProcurement extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__procurement', 'id', $db);
	}
	...
	{
		$k = $this->_tbl_key;
		return 'com_procurement.procurement.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = NULL, $id = NULL)
	{
		...
		if (($this->catid)&& !empty($this->catid))
		{
			...
			$assetParent->loadByName('com_procurement.category.' . (int) $this->catid);
		}
		else
		{
			// The item has the component as asset-parent
			$assetParent->loadByName('com_procurement');
		}
